...
//    }
    ...
    */
    @IBAction func tempMaxValueChanged(_ sender: UISlider) {
        let currentValue = Int(sender.value)
        
        tempMaxLabel.text = "\(currentValue)"
    }
    
    @IBAction func tempMinValueChanged(_ sender: UISlider) {
        let currentValue = Int(sender.value)
        
        tempMinLabel.text = "\(currentValue)"
    }
    ...
    @IBAction func benessereValueChanged(_ sender: UISlider) {
        let currentValue = Int(sender.value)
        
        benessereLabel.text = "\(currentValue)"
        
    }
    
    @IBAction func ecoValueChanged(_ sender: UISlider) {
        let currentValue = Int(sender.value)
        
        ecoLabel.text = "\(currentValue)"
    }
